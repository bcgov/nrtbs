...
* Methods: start with Scikit-learn and find something that runs in a finite amount of time. Try a few models in scikit-learn before moving to Pytorch or Keras/[Tensorflow](https://developers.google.com/machine-learning/crash-course)   
