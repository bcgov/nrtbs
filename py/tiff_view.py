...
with rasterio.open(tif_path) as src:
    ...
    plt.scatter(np.nan,np.nan,marker='s',s=100,label='Unburned',color='green')
    plt.scatter(np.nan,np.nan,marker='s',s=100,label='Low' ,color='yellow')
    plt.scatter(np.nan,np.nan,marker='s',s=100,label='Medium',color='orange')
    plt.scatter(np.nan,np.nan,marker='s',s=100,label='High',color='red')
